...
provider = IBMQ.get_provider(hub='deloitte-event23', group='level-2-access', project='eco-cult---level')
...
a_mos_ion = [11, 12, 13, 14, 15, 16]
a_mos_target = [8, 9, 10, 11, 12, 13]
a_mos_ligand = [22, 23, 24, 25, 26, 27]
...
ligand_loop = 'C; ' \
        'O 1 1.19619; ' \
        'O 1 1.19638 2 179.97438; ' \
        'Zn 3 {} 1 120.07056 2 180.00000'

#   Essential arguments for Computation section:
basis_set = 'sto3g'
bonding_distances = np.arange(0.50, 10.00, 0.15)
